...
## 0.2.6, выпущено 2026/08/11

* BUGFIX: flashsim — операции ввода-вывода (fseek/fread/fwrite/ftruncate)
  вынесены из assert(), чтобы они выполнялись и при NDEBUG (сборка Release).
  Ранее при отключённых assert() симулятор флеша превращался в no-op:
  файл-раздел оставался пустым, и ringfs обнаруживал повреждённую ФС.
